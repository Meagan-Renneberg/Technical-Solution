//function takes in a string of numbers and one or more delimiters of any length
...
//Test with same delimiter, different lengths
testOne = Add("//@,@@\n1@2@@3");
if(testOne != 6) {
    console.log("testOne failed");
}
//Test with different delimiters and lengths
testMult = Add("//##,$\n1##3$4");
if(testMult != 8) {
    console.log("testMult failed ");
}
//Test with $ delimiters and different lengths
testMult = Add("//$,$$\n1$$3$4");
if(testMult != 8) {
    console.log("testMult failed ");
}
